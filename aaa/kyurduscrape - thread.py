...
def save_to_sql(book_data):
  for book in book_data: 
    ...
    cursor = conn.cursor()
    isbn, book_name, author, publisher, link, image_url, price , category_name, sitename , tr_now= book
    ...
    if check_result:
        ...
        cursor.execute(check_query_3, category_name)
...
def main():
    ...
    category_urls =  [            
        # {"name": "Çocuk Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_2&filter_in_stock=1&sort=purchased_365&order=DESC&limit=100"},
        #{"name": "Ekonomi Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_380&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        # {"name": "Sınava Hazırlık Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_737&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        #{"name": "Sağlık  Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_344&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        #{"name": "Tarih Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_41&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        #{"name": "Hukuk Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_248&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        # {"name": "Edebiyat Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_128&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
         {"name": "Felsefe Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_424&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        # {"name": "Sanat Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_172&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        # {"name": "Din Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_64&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
        # {"name": "Bilim Kitapları", "url": "https://www.kitapyurdu.com/index.php?route=product/category", "category": "&filter_category_all=true&path=1_236&filter_in_stock=1&sort=publish_date&order=DESC&limit=100"},
    ]
